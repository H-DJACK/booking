      ...
      <div class="slider_brand" style="position:relative; z-index: -1;">
            <div class="flex w-100 mx-auto  items-center justify-center " 
                ...
                <div class="flex items-center justify-center flex-col " style="width: 60vw; margin: 30vh auto;" >
                    ...
                    <div>
                        <button class="bg-yellow-500 text-white text-xl p-2 rounded shadow-md mt-4">Explorer Maintenant</button>
                    </div>
                </div>
            </div>
            ...
            background-size: cover;">
                    <div class="flex items-center justify-center flex-col" style="width: 60vw; margin: 30vh auto;" >
                        ...
                        <p class="text-white text-lg ">Lorem ipsum dolor, sit amet consectetur adipisicing elit. 
                         ...
                         soluta praesentium reprehenderit minus! Aspernatur similique rerum quo sit vel, accusantium iste sapiente.</p>
                        <div>
                            <button class="bg-yellow-500 text-white text-xl p-2 rounded shadow-md mt-4">Participer Maintenant</button>
                        </div>
                    </div>
                </div>
                ...
                background-size: cover;">
                        <div class="flex items-center justify-center flex-col" style="width: 60vw; margin: 30vh auto;">
                         ...
                         soluta praesentium reprehenderit minus! Aspernatur similique rerum quo sit vel, accusantium iste sapiente.</p>
                            <div>
                                <button class="bg-yellow-500 text-white text-xl p-2 rounded shadow-md mt-4">Nous rejoindre</button>
                            </div>
                        </div>
                    </div>
        </div>
